...
class SignEspressoTest() {
    @get:Rule var activityTestRule = ActivityTestRule(SignActivity::class.java)
    ...
    @Test
    fun textChange() {
        onView(withId(R.id.emailEt)).perform(typeText("test01@gmail.com") , closeSoftKeyboard())
        onView(withId(R.id.passwordEt)).perform(typeText("test1234") , closeSoftKeyboard())
        onView(withId(R.id.passwordConfirmEt)).perform(typeText("test1234") , closeSoftKeyboard())
